...
class LocalBroker(CallBackType):
    def __init__(self, log, brokerClient, timeGenerator, singleTrader, dataFromServer, balanceLog):
        ...
        super(CallBackType, self).__init__(log, brokerClient, timeGenerator, singleTrader, dataFromServer)
