...
def get_dataProvider(userConfig, dataProviderName=None):
    ...
    if name == DataProviderName.LOCAL_FILE:
        ...
        t = Robinhood(userConfig.log, userConfig.brokerClientFactory.get_brokerClient_by_name(BrokerClientName.ROBINHOOD, userConfig), userConfig.projectConfig.useColumnNameWhenSimulatedByDailyBar)
        ...
        t = YahooFinance(userConfig.log, None, userConfig.projectConfig.useColumnNameWhenSimulatedByDailyBar)
    else:
