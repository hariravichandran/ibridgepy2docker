...
class NonRandom(DataProvider):
    def __init__(self, log, dataProviderClient, useColumnNameWhenSimulatedByDailyBar):
        super(NonRandom, self).__init__(log, dataProviderClient, useColumnNameWhenSimulatedByDailyBar)
        self._1minHist = {}
