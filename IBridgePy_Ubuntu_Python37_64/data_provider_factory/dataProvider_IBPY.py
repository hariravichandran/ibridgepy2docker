...
class IBPY(NonRandom):
    def __init__(self, log, apiKey, useColumnNameWhenSimulatedByDailyBar):
        super(IBPY, self).__init__(log, None, useColumnNameWhenSimulatedByDailyBar)
        self._log = log
        if apiKey:
